...
namespace tide
{
    /** \brief Base class for individual track operations.
     *
    ...
    class TIDE_EXPORT TrackOperationBase : public MasterElement
    {
        public:
            ...
            unsigned int uid_count() const { return uids_.size(); }

            /// TODO: Proper iterator model for UIDs.
    ...
    class TIDE_EXPORT TrackOperation : public MasterElement
    {
        public:
             ...
             *
             * The operations must be applied in the order they appear in the
             * file.
             */
            std::vector<TrackOperationBase> const& operations() const;
