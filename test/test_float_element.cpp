...
TEST(FloatElement, CopyConstruction)
{
    ...
    EXPECT_EQ(1234, tide::FloatElement(tide::FloatElement(1234, 1.0, 2.0)).id());
    EXPECT_EQ(1.0, tide::FloatElement(tide::FloatElement(1234, 1.0, 2.0)).value());
    EXPECT_EQ(2.0, tide::FloatElement(tide::FloatElement(1234, 1.0, 2.0)).get_default());
...
TEST(FloatElement, SetID)
{
    ...
    EXPECT_THROW(tide::FloatElement(1, 1.0).id(0xFFFF),
            tide::InvalidElementID);
...
{
    EXPECT_EQ(1, tide::FloatElement(1234, 1.0).value());
    EXPECT_EQ(1, tide::FloatElement(1234, 1.0, 2.0).value());
